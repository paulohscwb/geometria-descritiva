...
<details open><summary id="basico">Uso dos materiais básicos de Desenho</summary>
	...
	<figcaption>O conteúdo de desenhos e legendas desta parte da apostila foi produzido pela prof&ordf; Deise Maria Bertholdi Costa.</figcaption>
...
<details open>
  <summary id="propriedades">1. Propriedades das projeções cilíndricas</summary>
	...
	<figcaption>O conteúdo de desenhos e legendas desta parte da apostila foi produzido pelo prof. Paulo Henrique Siqueira.</figcaption>
...
<details><summary id="pontos">2. Pontos e Retas</summary>
	...
	<figcaption>O conteúdo de desenhos e legendas desta parte da apostila, da página 14 até a página 18, foi produzido pelo prof. Paulo Henrique Siqueira.</figcaption>
  ...
  <a href="vr/a_epura3.html" target="_blank" class="visu">Visualização em 3D</a></div>
	<p class="topop"><a href="#pontos" class="topo">voltar ao topo</a></p>
	<figcaption>O conteúdo de desenhos e legendas desta parte da apostila, da página 19 até a página 32, foi produzido pela prof&ordf; Bárbara de Cássia Xavier Cassins Aguiar.</figcaption>
  ...
  <ul class="slider">
	  ...
	  <li>
	   ...
	   <li>
           ...
           <label for="417"></label>
           <img src="pontos-retas/21_10_09.png"/>
         <figcaption></figcaption>
       </li>
	   <li>
           <input type="radio" id="418" name="sl">
           <label for="418"></label>
           <img src="pontos-retas/21_10_10.png"/>
         <figcaption></figcaption>
       </li>
	   <li>
           <input type="radio" id="419" name="sl">
           <label for="419"></label>
           <img src="pontos-retas/21_10_11.png"/>
         <figcaption></figcaption>
       </li>
	   <li>
           <input type="radio" id="420" name="sl">
           <label for="420"></label>
           <img src="pontos-retas/21_10_12.png"/>
         <figcaption></figcaption>
       </li>
	   <li>
           <input type="radio" id="421" name="sl">
           <label for="421"></label>
           <img src="pontos-retas/21_10_13.png"/>
         <figcaption></figcaption>
       </li>
    </ul>
	<img src="pontos-retas/21_10_00.png" class="fundo"/>
  </details>
  <details class="sub"><summary>&#x1f4cf; &#x1f4d0; Resolução do item b</summary>
  <p></p>
  <ul class="slider">
      <li>
           ...
           <label for="422"></label>
           <img src="pontos-retas/21_10b_01.png"/>
        <figcaption></figcaption>
       </li>
	  <li>
           <input type="radio" id="423" name="sl">
           <label for="423"></label>
           <img src="pontos-retas/21_10b_02.png"/>
        <figcaption></figcaption>
       </li>
       <li>
           <input type="radio" id="424" name="sl">
           <label for="424"></label>
           <img src="pontos-retas/21_10b_03.png"/>
         <figcaption></figcaption>
       </li>
	   <li>
           <input type="radio" id="425" name="sl">
           <label for="425"></label>
           <img src="pontos-retas/21_10b_04.png"/>
         <figcaption></figcaption>
       </li>
	   <li>
           <input type="radio" id="426" name="sl">
           <label for="426"></label>
           <img src="pontos-retas/21_10b_05.png"/>
         <figcaption></figcaption>
       </li>
	   <li>
           <input type="radio" id="427" name="sl">
           <label for="427"></label>
           <img src="pontos-retas/21_10b_06.png"/>
         <figcaption></figcaption>
       </li>
	   <li>
           <input type="radio" id="428" name="sl">
           <label for="428"></label>
           <img src="pontos-retas/21_10b_07.png"/>
         <figcaption></figcaption>
       </li>
	   <li>
           <input type="radio" id="429" name="sl">
           <label for="429"></label>
           <img src="pontos-retas/21_10b_08.png"/>
         <figcaption></figcaption>
       </li>
	   <li>
           <input type="radio" id="429a" name="sl">
           <label for="429a"></label>
           <img src="pontos-retas/21_10b_09.png"/>
         <figcaption></figcaption>
       </li>
	   <li>
           <input type="radio" id="430" name="sl">
           <label for="430"></label>
           <img src="pontos-retas/21_10b_10.png"/>
         <figcaption></figcaption>
       </li>
	   <li>
           <input type="radio" id="431" name="sl">
           <label for="431"></label>
           <img src="pontos-retas/21_10b_11.png"/>
         <figcaption></figcaption>
       </li>
	   <li>
           <input type="radio" id="432" name="sl">
           <label for="432"></label>
           <img src="pontos-retas/21_10b_12.png"/>
         <figcaption></figcaption>
       </li>
    </ul>
  ...
  <ul class="slider">
	...
	<p class="topop"><a href="#pontos" class="topo">voltar ao topo</a></p>
	<figcaption>O conteúdo de desenhos e legendas desta parte da apostila, da página 33 até a página 37, foi produzido pelo prof. Emerson Rolkouski.</figcaption>
  ...
  <ul class="slider">
	  ...
	  <li>
	   ...
	   <li>
        ...
        <figcaption>Para representar o ponto Q da reta s de afastamento 20 trace uma paralela à  LT com distância 20.</figcaption>
       </li>
	   <li>
...
<details><summary id="planos1">3. Planos: horizontal e frontal</summary>
	...
	<figcaption>O conteúdo de desenhos e legendas desta parte da apostila, da página 38 até a página 48, foi produzido pelo prof. Emerson Rolkouski.</figcaption>
  ...
  <ul class="slider">
	...
	<p class="topop"><a href="#planos1" class="topo">voltar ao topo</a></p>
	<figcaption>O conteúdo de desenhos e legendas desta parte da apostila, da página 49 até a página 53, foi produzido pela prof&ordf; Simone da Silva Soria Medina.</figcaption>
...
<details><summary id="planos2">4. Planos: de perfil e de topo</summary>
	...
	<figcaption>O conteúdo de desenhos e legendas desta parte da apostila, da página 54 até a página 64, foi produzido pela prof&ordf; Simone da Silva Soria Medina.</figcaption>
  ...
  <ul class="slider">
	...
	<p class="topop"><a href="#planos2" class="topo">voltar ao topo</a></p>
	<figcaption>O conteúdo de desenhos e legendas desta parte da apostila, da página 65 até a página 80, foi produzido pela prof&ordf; Luzia Vidal de Souza.</figcaption>
...
<details><summary id="planos3">5. Planos: vertical e paralelo à linha de terra</summary>
  ...
  <ul class="slider">
	...
	<p class="topop"><a href="#planos3" class="topo">voltar ao topo</a></p>
	<figcaption>O conteúdo de desenhos e legendas desta parte da apostila, da página 81 até a página 86, foi produzido pela prof&ordf; Deise Maria Bertholdi Costa.</figcaption>
